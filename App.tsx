        ...
        <div className="flex md:justify-center gap-4 md:gap-8 mb-16 overflow-x-auto md:overflow-visible pb-4 md:pb-0 px-4">
          ...
          {(['organizers', 'co-organizers', 'core'] as TeamTab[]).map((tab) => (
            <button
              ...
              className={`whitespace-nowrap px-8 py-3 rounded-2xl font-stylish font-bold text-xs md:text-sm tracking-widest uppercase transition-all duration-300 border ${activeTeamTab === tab
